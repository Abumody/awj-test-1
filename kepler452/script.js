...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam11'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam11'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam11_completed'] = true;
        students[student].tests['exam11_completedAt'] =
          students[student].tests['exam11_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
