...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam8'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam8'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam8_completed'] = true;
        students[student].tests['exam8_completedAt'] =
          students[student].tests['exam8_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
