...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam16'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam16'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam16_completed'] = true;
        students[student].tests['exam16_completedAt'] =
          students[student].tests['exam16_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
