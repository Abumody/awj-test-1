...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam14'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam14'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam14_completed'] = true;
        students[student].tests['exam14_completedAt'] =
          students[student].tests['exam14_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
