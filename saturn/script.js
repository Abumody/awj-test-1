...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam6'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam6'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam6_completed'] = true;
        students[student].tests['exam6_completedAt'] =
          students[student].tests['exam6_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
