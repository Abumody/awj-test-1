...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam10'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam10'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam10_completed'] = true;
        students[student].tests['exam10_completedAt'] =
          students[student].tests['exam10_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
