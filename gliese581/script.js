...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam13'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam13'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam13_completed'] = true;
        students[student].tests['exam13_completedAt'] =
          students[student].tests['exam13_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
