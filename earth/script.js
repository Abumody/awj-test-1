...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam3'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam3'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam3_completed'] = true;
        students[student].tests['exam3_completedAt'] =
          students[student].tests['exam3_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
