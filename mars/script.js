...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam4'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam4'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam4_completed'] = true;
        students[student].tests['exam4_completedAt'] =
          students[student].tests['exam4_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
