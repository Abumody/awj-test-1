...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam5'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam5'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam5_completed'] = true;
        students[student].tests['exam5_completedAt'] =
          students[student].tests['exam5_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
