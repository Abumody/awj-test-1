...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam15'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam15'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam15_completed'] = true;
        students[student].tests['exam15_completedAt'] =
          students[student].tests['exam15_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
