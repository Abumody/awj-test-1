...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam17'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam17'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam17_completed'] = true;
        students[student].tests['exam17_completedAt'] =
          students[student].tests['exam17_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
