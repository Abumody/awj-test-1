...
(function() {
  ...
  function getScores() {
    ...
    return studentData.tests['exam12'] || {};
  }
  ...
  function saveScores(scores) {
    ...
    students[student].tests['exam12'] = scores;
  ...
  function updateUI() {
    ...
    if (allCompleted && total > 0) {
      ...
      if (students[student]) {
        ...
        students[student].tests['exam12_completed'] = true;
        students[student].tests['exam12_completedAt'] =
          students[student].tests['exam12_completedAt'] || new Date().toISOString();
        localStorage.setItem('students', JSON.stringify(students));
      }
    }
  }
